...
export class KeycloakStrategy extends PassportStrategy(Strategy, 'keycloak') { // Définit une stratégie Passport appelée 'keycloak'.
  constructor() {
    super({
      ...
      issuer: 'http://localhost:8080/realms/khalid', // Identifie l'émetteur attendu du JWT. À la place de XXX, il faut mettre le nom du Realm
      ...
      secretOrKeyProvider: passportJwtSecret({
        ...
        jwksUri: 'http://localhost:8080/realms/khalid/protocol/openid-connect/certs' // URL pour récupérer les clés publiques JWKS de Keycloak.À la place de XXX, il faut mettre le nom du Realm
      }),
    });
  }
